  ...
  describe("subcommands via :Hermes", function()
    it("accepts 'version' subcommand", function()
      ...
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes version") end)
      end)
    end)
    
    it("accepts 'clean' subcommand", function()
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes clean") end)
      end)
    end)
    
    it("accepts 'setup' subcommand", function()
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes setup") end)
      end)
    end)
    
    it("accepts no arguments (shows help)", function()
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes") end)
      end)
    end)
    ...
    it("accepts 'install' subcommand", function()
      ...
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes install") end)
      end)
    end)
    ...
    it("accepts 'build' subcommand", function()
      ...
      assert.has_no.errors(function()
        pcall(function() vim.cmd("Hermes build") end)
      end)
    end)
  end)
