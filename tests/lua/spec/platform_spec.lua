...
describe("hermes.platform", function()
	...
	after_each(function()
		if os_uname_stub then
			os_uname_stub:revert()
		end
	end)
	...
	describe("get_ext()", function()
		...
		it("returns so on Linux", function()
			get_os_stub = stub(platform, "get_os").returns("linux")
			assert.equals("so", platform.get_ext())
		end)

		it("returns dylib on macOS", function()
			get_os_stub = stub(platform, "get_os").returns("macos")
			assert.equals("dylib", platform.get_ext())
		end)

		it("returns dll on Windows", function()
			get_os_stub = stub(platform, "get_os").returns("windows")
